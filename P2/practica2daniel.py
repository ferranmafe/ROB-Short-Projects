...
from math import sin, cos, fmod, atan2
...
def computeOrientationToBase(x_base, y_base):
    threshold_ang = 5 * 3.1415 / 180
    rot_ang = atan2((y_base- y_w), (x_base - x_w)) + sum_theta
    while  threshold_ang < rot_ang or threshold_ang > rot_ang
        speed = 50
        direction = 0
        tita_dot = (3.1415/10)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if tecla != "q":
            ...
            # Computamos el giro del NEATO para orientarse hacia la base
            computeOrientationToBase(x_base, y_base)
